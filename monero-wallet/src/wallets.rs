...
impl Wallets {
    ...
    pub async fn swap_wallet_spendable(
        ...
        let address = {
            let public_spend_key = monero_amount::PublicKey::from_private_key(&spend_key);
            let public_view_key = monero_amount::PublicKey::from_private_key(&view_key.into());
...
impl Wallets {
    ...
    pub async fn verify_transfer(
        &self,
        tx_hash: &TxHash,
        public_spend_key: monero_amount::PublicKey,
