...
use crate::ext::{self, Address, Amount, PunishTimelock, Transaction, TxCancel, Txid};
...
impl TxPunish {
    ...
    pub fn complete(
        self,
        tx_punish_sig_bob: crate::ext::Signature,
        a: crate::ext::SecretKey,
        B: crate::ext::PublicKey,
    ) -> Result<Transaction> {
