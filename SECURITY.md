...
If you believe you found a security vulnerability, please do not share it publicly. 
Follow the responsible disclosure procedure by submitting a private message. 
You can do so on GitHub (see the "Security") tab or on matrix (message @einliterflasche2:matrix.org or @binarybaron:matrix.org).
