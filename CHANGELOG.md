...
- Add optional `bitcoind` RPC backend for the Bitcoin wallet (bounty #747). Users can now sync directly from their own full node instead of relying on Electrum servers. Configure via `WalletConfig::rpc_backend`.
## [Unreleased]
