...
- ASB: The swap orchestrator can optionally add a fail-closed killswitch sidecar.
  It supervises the ASB and stops it when the Eigenwallet killswitch endpoint is active or unavailable.
